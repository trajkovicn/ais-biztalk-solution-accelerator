...
> **Colour key:** 🟦 Blue = always-deployed core service | Light blue = optional (Integration Account, Liquid LA) | 🟪 Purple = Storage | 🟩 Green = networking (VNet, PEs, DNS) | 🟨 Yellow = external caller
